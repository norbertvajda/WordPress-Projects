		...
		<div class="container">			
			<div class="row">
				<div class="col-12 link-center">
					<h2><a class="irany_a_bolt" href="#">Néhány szó a technikáról</a></h2>
				</div>
			</div>
			<div class="row justify-content-around">
				<div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 bios">
					<div class="photo"><img src="https://fagravir.com/wp-content/uploads/2019/03/fagravir.png" alt="sample"></div>
